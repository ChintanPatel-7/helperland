#pragma checksum "D:\Company\Training\PSD to HTML\website\helperland\Helperland\Views\Customer\Dashboard.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "918e02b0803ef41b500d91c66cd85f1cc8f6a896"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"918e02b0803ef41b500d91c66cd85f1cc8f6a896", @"/Views/Customer/Dashboard.cshtml")]
...
#nullable disable
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "918e02b0803ef41b500d91c66cd85f1cc8f6a8965683", async() => {
        ...
        <div class=""modal-content"">
            <div class=""modal-body"">
                ...
                <div class=""row"">
                    ...
                    <div class=""col-md-6 col-sm-12 pe");
            WriteLiteral("-2 ps-2 pt-2\">\r\n                        <select class=\"form-select\" id=\"RescheduleServiceTime\">\r\n");
#nullable restore
#line 42 "D:\Company\Training\PSD to HTML\website\helperland\Helperland\Views\Customer\Dashboard.cshtml"
...
#nullable disable
            WriteLiteral("                                ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "918e02b0803ef41b500d91c66cd85f1cc8f6a8969727", async() => {
                WriteLiteral(" ");
#nullable restore
#line 45 "D:\Company\Training\PSD to HTML\website\helperland\Helperland\Views\Customer\Dashboard.cshtml"
                                               Write(number[0]);
...
");
               ...
               ");
                WriteLiteral(@"                     totalRating = totalRating + element.ratings;
                                ...
                                if (count == 0) {
                                    return ""<div><img src='"" + row.user.userProfilePicture + ""' class='cap-img float-start' alt='cap image'> "" +
                         ...
                         ");
                WriteLiteral(@"           ""<input id='sprating_"" + row.user.userId + ""_"" + row.serviceRequestId + ""' class='spRating' value='"" + spRatingRounded + ""' type='text' title='' hidden>"";
                            }
                        }
                    },
                    {
                    ...
                    },
                    {
                        render: function (data, type, row) {
                            ...
                            if (serviceDate > currentDate) {
                                htmlComtent = ""<button class='btn rounded-pill button-primary p-1 fs-14' onclick='OpenRescheduleServiceRequestModel("" + row.serviceReque");
                WriteLiteral(@"stId + "", false)'>Reschedule</button>"";
                            }
            ...
            $('#tblCurrentServiceRequest tbody').on('click', 'td', function () {
                ...
                $.ajax({
                    ...
                    success: function (resp) {
                       ...
                       ");
                WriteLiteral(@" var serviceAddress = resp.data.serviceRequestAddresses[0];
                        ...
                        var currentDate = new Date();
      ");
                WriteLiteral(@"                  var serviceDate = new Date(resp.data.serviceStartDate);
                        ...
                        $('#CustSer");
                WriteLiteral(@"viceDetailModel').modal({
                            backdrop: 'static',
                            keyboard: false
                        });
        ...
        function OpenRescheduleServiceRequestModel(serviceRequestId, closeServiceDetailModel) {
            ...
            ");
                WriteLiteral(@"        serviceRequestHour = Math.round(serviceRequestHour * 10) / 10;
        ...
        function UpdateRescheduleServiceRequest() {
            ...
            $.ajax({
                url: '/Customer/UpdateRescheduleServi");
                WriteLiteral(@"ceRequest',
                type: 'post',
                dataType: 'json',
        ...
        function OpenCancelServiceRequestModel(serviceRequestId, closeServiceDetailModel) {
            ...
            if (closeServiceDetailModel == true) {
               ");
                WriteLiteral(@" $('#CustServiceDetailModel').modal('hide');
            }
        ...
        function CancelServiceRequestModel() {
            ...
            $.ajax({
                url: ");
                WriteLiteral(@"'/Customer/CancelServiceRequest',
                type: 'post',
                dataType: 'json',
                contentType: 'application/json',
                data: JSON.stringify(serviceRequest),
