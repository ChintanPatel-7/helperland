#pragma checksum "D:\Company\Training\PSD to HTML\website\helperland\Helperland\Views\Customer\ServiceHistory.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "2a26981bc0aa65c7099799596dacc2c687fb00fd"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"2a26981bc0aa65c7099799596dacc2c687fb00fd", @"/Views/Customer/ServiceHistory.cshtml")]
        ...
        <div class=""modal-content"">
            <div class=""modal-body"">
                ...
                <div class=""clearfix mb-3 align-items-center d-flex"">
                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("img", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagOnly, "2a26981bc0aa65c7099799596dacc2c687fb00fd7444", async() => {
            }
            );
    ...
    <div class=""modal-dialog modal-dialog-centered modal-lg"">
        <div class=""modal-content"">
            <div class=""modal-body"">
                ...
                <span class=""text""><b>Extras:</b> <label id=""lbl");
            WriteLiteral(@"ExtraServices"" class=""d-inline""></label></span>
  ...
  ");
                ...
                WriteLiteral(@"                 totalRating = totalRating + element.ratings;
                                ...
                                return ""<div><img src='../img/admin-panel/cap.png' class='cap-img float-start' alt='cap image'> "" +
                                    ...
                                    ""<input id=");
                WriteLiteral(@"'sprating_"" + row.user.userId + ""_"" + row.serviceRequestId + ""' class='spRating' value='"" + spRatingRounded + ""' type='text' title='' hidden>"";
                            }
                        }
                    },
                    {
                    ...
                    },
                    {
                        render: function (data, type, row) {
                            if (row.status == ");
#nullable restore
#line 216 "D:\Company\Training\PSD to HTML\website\helperland\Helperland\Views\Customer\ServiceHistory.cshtml"
                                         Write(compeleted);
...
#nullable restore
#line 219 "D:\Company\Training\PSD to HTML\website\helperland\Helperland\Views\Customer\ServiceHistory.cshtml"
                                              Write(cancelled);
...
#nullable restore
#line 235 "D:\Company\Training\PSD to HTML\website\helperland\Helperland\Views\Customer\ServiceHistory.cshtml"
                                                                                                                                                                                    Write(cancelled);
...
#nullable disable
            ...
            $('#tblServiceHistory tbody').on('click', 'td', function () {
             ...
             ");
                WriteLiteral(@"           $(""#lblServiceRequestDateTime"").html(""<b>"" + ServiceStartDate(resp.data.serviceStartDate) + ""</b> "" +
                        ...
                        $(""#lblEm");
                WriteLiteral(@"ail"").text(resp.data.user.email);
  ...
  ");
                WriteLiteral(@"                      $('#ServiceDetailModelServiceHistoryPage').modal('show');
                    },
                    error: function (err) {
                        console.log(err);
                    }
        ...
        function ExportExcel() {
            ...
            for (let i = 0; i < tblData.length; i++) {
                ...
                if (tblData[i].user == null) {
                   ...
                   ");
                WriteLiteral(" csvContent += tblData[i].user.firstName + \" \" + tblData[i].user.lastName + \",\";\r\n                }\r\n\r\n                csvContent += tblData[i].totalCost + \"$,\";\r\n\r\n                if (tblData[i].status == ");
#nullable restore
#line 325 "D:\Company\Training\PSD to HTML\website\helperland\Helperland\Views\Customer\ServiceHistory.cshtml"
                                    Write(compeleted);
...
#nullable restore
#line 328 "D:\Company\Training\PSD to HTML\website\helperland\Helperland\Views\Customer\ServiceHistory.cshtml"
                                         Write(cancelled);
...
#nullable disable
     ...
     ");
          ...
          ");
                WriteLiteral(@"              $(""#divRatingQualityOfService"").html(""<input id='RatingQualityOfService' class='rating-serviceProvider-disabled' value='"" + parseFloat(resp.result.qualityOfService) + ""' type='text' title='' hidden>"")
                        ...
                        $(""#ratingMessage"").html(""You have already rated on "" + ServiceStartDate(resp.result.ratingDate) + "" "" + ServiceTime(resp.result.ratingDa");
                WriteLiteral(@"te, 0)) + ""."";
                    }
        ...
        function SubmitRating() {
            ...
            rating.");
                WriteLiteral(@"ratings = Math.round(totalRatingSp * 10) / 10;
