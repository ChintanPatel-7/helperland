#pragma checksum "D:\Company\Training\PSD to HTML\website\helperland\Helperland\Views\ServiceProvider\NewServiceRequests.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e1b0e3d919cb745c243560957da6c4ab9e4d8923"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e1b0e3d919cb745c243560957da6c4ab9e4d8923", @"/Views/ServiceProvider/NewServiceRequests.cshtml")]
...
<div class=""div-table"">
    ...
    ");
                WriteLiteral(@"                    $(""#lblSpTotalAmount"").html(""<b>"" + resp.data.totalCost + "" $</b>"");
                        ...
                        if (resp.data.hasPets == false) {
                            ...
                            $(""#lblSpHasPet "").html(""<img src='../img/admin-pane");
                WriteLiteral(@"l/included.png'/> I have pets at home"");
                        }
        ...
        function AcceptServiceRequest(serviceRequestId, recordVersion) {
            ...
            $.ajax({
                ...
                success: function (resp) {
                    ...
                    ");
                WriteLiteral(@"        text: 'You have successfully accept Service Request : ' + serviceRequestId,
